...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/SiteManage/Views/District/_/AsyncEditTree.cshtml")]
    public partial class _Areas_SiteManage_Views_District___AsyncEditTree_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_SiteManage_Views_District___AsyncEditTree_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 2 "..\..\Areas\SiteManage\Views\District\_\AsyncEditTree.cshtml"
...
"nction (node) {\r\n                jQuery.ajax({\r\n                    url: _baseUr" +
"l + \'/SaveEditTreeFieldAction\',\r\n                    type: \'post\',\r\n            " +
"        dataType: \'json\',\r\n                    data: {\r\n                        " +
"id: node.id,\r\n                        value: node.text\r\n                    },\r\n" +
"                    success: function (data) {\r\n                        if (data" +
".success) {\r\n                            var node = $(\'#tt\').tree(\'getRoot\');\r\n " +
"                       } else {\r\n                            alert(data.message)" +
";\r\n                        }\r\n                        jQuery(\'#tt\').tree(\"reload" +
"\", node);\r\n                    }\r\n                });\r\n            },\r\n         " +
"   onDrop: function (target, source, point) {\r\n                var targetId = jQ" +
"uery(\'#tt\').tree(\'getNode\', target).id;\r\n                jQuery.ajax({\r\n        " +
