...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/SiteManage/Views/DictType/_/EditTree.cshtml")]
    public partial class _Areas_SiteManage_Views_DictType___EditTree_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_SiteManage_Views_DictType___EditTree_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 2 "..\..\Areas\SiteManage\Views\DictType\_\EditTree.cshtml"
...
"           }\r\n                });\r\n            },\r\n            onDrop: function " +
"(target, source, point) {\r\n\r\n                var targetId = jQuery(\'#tt\').tree(\'" +
"getNode\', target).id;\r\n\r\n                jQuery.ajax({\r\n                    url:" +
" _apiUrl + \'/SaveEditTree\',\r\n                    type: \'post\',\r\n                " +
"    dataType: \'json\',\r\n                    data: {\r\n                        id: " +
"source.id,\r\n                        targetId: targetId,\r\n                       " +
" point: point\r\n                    },\r\n                    success: function (da" +
"ta) {\r\n                        if (data.success) {\r\n                            " +
