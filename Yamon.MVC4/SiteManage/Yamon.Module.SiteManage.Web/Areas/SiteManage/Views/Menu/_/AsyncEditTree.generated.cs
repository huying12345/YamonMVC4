...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/SiteManage/Views/Menu/_/AsyncEditTree.cshtml")]
    public partial class _Areas_SiteManage_Views_Menu___AsyncEditTree_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_SiteManage_Views_Menu___AsyncEditTree_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 2 "..\..\Areas\SiteManage\Views\Menu\_\AsyncEditTree.cshtml"
...
"ction () {\r\n        jQuery(\'#tt\').tree({\r\n            url: _baseUrl + \"/AsyncEdi" +
"tTree?\" + _pageUrl,\r\n            animate: true,\r\n            dnd: true,\r\n       " +
"     \r\n            onDblClick: function (node) {\r\n                jQuery(\'#tt\')." +
"tree(\'beginEdit\', node.target);\r\n            },\r\n            onAfterEdit: functi" +
"on (node) {\r\n                jQuery.ajax({\r\n                    url: _baseUrl + " +
"\'/SaveEditTreeFieldAction\',\r\n                    type: \'post\',\r\n                " +
"    dataType: \'json\',\r\n                    data: {\r\n                        id: " +
"node.id,\r\n                        value: node.text\r\n                    },\r\n    " +
"                success: function (data) {\r\n                        if (data.suc" +
"cess) {\r\n                            var node = $(\'#tt\').tree(\'getRoot\');\r\n     " +
"                   } else {\r\n                            alert(data.message);\r\n " +
"                       }\r\n                        jQuery(\'#tt\').tree(\"reload\", n" +
"ode);\r\n                    }\r\n                });\r\n            },\r\n            o" +
"nDrop: function (target, source, point) {\r\n                var targetId = jQuery" +
"(\'#tt\').tree(\'getNode\', target).id;\r\n                jQuery.ajax({\r\n            " +
