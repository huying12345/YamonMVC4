...
namespace Yamon.Module.SiteManage.Web.Controllers
{
    ...
    public partial class _SystemConfigController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new SystemConfigDAL();
            ...
            string formPath = string.Format("~/Areas/SiteManage/Views/SystemConfig/_/{0}.cshtml", m);
...
public virtual ActionResult Edit(string id = "")
{
    ...
    string formPath = SiteCommon.GetCustomPage("~/Areas/SiteManage/Views/SystemConfig/_/Edit.cshtml");
