...
namespace Yamon.Module.SiteManage.Web.Controllers
{
    ...
    public partial class _LogController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            string formPath = string.Format("~/Areas/SiteManage/Views/Log/_/{0}.cshtml", m);
...
public virtual ActionResult Show(string id = "")
{
    ...
    string formPath = SiteCommon.GetCustomPage("~/Areas/SiteManage/Views/Log/_/Show.cshtml");
