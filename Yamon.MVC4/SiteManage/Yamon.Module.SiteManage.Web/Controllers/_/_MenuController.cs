...
namespace Yamon.Module.SiteManage.Web.Controllers
{
    ...
    public partial class _MenuController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            string formPath = string.Format("~/Areas/SiteManage/Views/Menu/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    Menu model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/SiteManage/Views/Menu/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/SiteManage/Views/Menu/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    Menu model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/SiteManage/Views/Menu/_/Show.cshtml");
    return View(formPath,model);
}
 		public ActionResult ImportFromExcel()
		{
			string formPath = "~/Areas/SiteManage/Views/Menu/_/ImportFromExcel.cshtml";
			string myFormPath = "~/Areas/SiteManage/Views/Menu/ImportFromExcel.cshtml";
			//是否有自定义页面
