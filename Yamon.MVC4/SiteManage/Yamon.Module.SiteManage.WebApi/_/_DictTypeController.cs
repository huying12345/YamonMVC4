...
namespace Yamon.Module.SiteManage.WebApi
{
    ...
    public partial class _DictTypeController :BaseController
    {
        ...
        [ValidateInput(false)]
        [LogFilter]
        public virtual ActionResult Create(DictType model,bool returnData=false)
        {
            object newId = "";
            try
            {
                ...
                if (result > 0)
                {
                            newId = model.DictTypeID;

                    hash["id"] = newId;
                    if(returnData){
                        DictType newrow = dal.GetModelByID(newId);
                        hash["data"] = newrow;
                    }
                }
        ...
        [LogFilter]
        public virtual ActionResult Edit(DictType model,bool returnData=false)
        {
            try
            {
               ...
               if (result > 0)
                {
                    hash["id"] = model.DictTypeID;
                    if(returnData){
                        DictType newrow = dal.GetModelByID(model.DictTypeID);
                        hash["data"] = newrow;
                    }
                }
            }
        ...
        [NonAction]        
        public  virtual List<DictType> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<DictType> modelList = new List<DictType>();
            switch(filterId)
            {
                    case "DictType_Module":
                    {
                      modelList = dal.GetEntityListByPage_Module(out totalRows,0,page,rows,orderby);
                      break;
                    }
		...
		public  virtual ActionResult TreeGridByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                        case "DictType_Module":
                        {
                          modelList = dal.GetEntityListByPage_Module(out _totalRows,0,page,rows);
                          break;
                        }
               ...
               List<DictType> newModelList = modelList.Select(model => dal.GetModelGridShowValue(model)).ToList();
        ...
        public  virtual ActionResult TreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                string fields="DictTypeID,DictTypeName,ParentID,OrderID";
                ...
                switch(filterId)
                {
                        case "DictType_Module":
                        {
                          table = dal.GetAllEntityTable_Module(fields);
                          break;
                        }
                ...
                TreeHelper treeHelper = new TreeHelper("DictTypeID", "DictTypeName", "OrderID", "ParentID");
		...
		public  virtual ActionResult AsyncTreeGridByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
					case "DictType_Module":
					{
					  modelList = dal.GetAsyncModelTreeList_Module(parentId);
					  break;
					}
        ...
        public  virtual ActionResult AsyncTreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                        case "DictType_Module":
                        {
                          table = dal.GetAsyncTreeList_Module(parentId,"DictTypeID,DictTypeName");
                          break;
                        }

                     default:
                     {
                        table = dal.GetAsyncTreeList(parentId,"DictTypeID,DictTypeName");
                        break;
                     }
                }
                TreeHelper treeHelper = new TreeHelper("DictTypeID", "DictTypeName", "OrderID", "ParentID");
        ...
        {
            int result = dal.UpdateSingleFieldValue("DictTypeName", value,id );
            hash["success"] = result > 0;
            return Json(hash);
        }   
    [LogFilter]
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"SiteManage_DictType_Show")]        
