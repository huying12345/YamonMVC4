...
namespace Yamon.Module.SiteManage.WebApi
{
    ...
    public partial class _APIController :BaseController
    {
        ...
        [ValidateInput(false)]
        [LogFilter]
        public virtual ActionResult Create(API model,bool returnData=false)
        {
            object newId = "";
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    hash["id"] = newId;
                    if(returnData){
                        API newrow = dal.GetModelByID(newId);
                        hash["data"] = newrow;
                    }
                }
        ...
        [LogFilter]
        public virtual ActionResult Edit(API model,bool returnData=false)
        {
            try
            {
               ...
               if (result > 0)
                {
                    hash["id"] = model.APIID;
                    if(returnData){
                        API newrow = dal.GetModelByID(model.APIID);
                        hash["data"] = newrow;
                    }
                }
            }
        ...
        [NonAction]        
        public  virtual List<API> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<API> modelList = new List<API>();
            switch(filterId)
            {
                    case "API_APIType":
                    {
                      modelList = dal.GetEntityListByPage_APIType(out totalRows,0,page,rows,orderby);
                      break;
                    }
		...
		public  virtual ActionResult TreeGridByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                        case "API_APIType":
                        {
                          modelList = dal.GetEntityListByPage_APIType(out _totalRows,0,page,rows);
                          break;
                        }
        ...
        public  virtual ActionResult TreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                string fields="APIID,APIName,ParentID,OrderID";
                ...
                switch(filterId)
                {
                        case "API_APIType":
                        {
                          table = dal.GetAllEntityTable_APIType(fields);
                          break;
                        }
		...
		public  virtual ActionResult AsyncTreeGridByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
					case "API_APIType":
					{
					  modelList = dal.GetAsyncModelTreeList_APIType(parentId);
					  break;
					}
        ...
        public  virtual ActionResult AsyncTreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                        case "API_APIType":
                        {
                          table = dal.GetAsyncTreeList_APIType(parentId,"APIID,APIName");
                          break;
                        }

                     default:
                     {
                        table = dal.GetAsyncTreeList(parentId,"APIID,APIName");
                        break;
                     }
                }
                TreeHelper treeHelper = new TreeHelper("APIID", "APIName", "OrderID", "ParentID");
        ...
        {
            int result = dal.UpdateSingleFieldValue("APIName", value,id );
            hash["success"] = result > 0;
            return Json(hash);
        }   
    [LogFilter]
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        public ActionResult ImportFromExcel()
        {
            ...
            return Json(hash);
        }        [CheckPurview(pageCode:"SiteManage_API_Show")]        
