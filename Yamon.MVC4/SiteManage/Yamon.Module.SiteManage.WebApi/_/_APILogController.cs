...
namespace Yamon.Module.SiteManage.WebApi
{
    ...
    public partial class _APILogController :BaseController
    {
        ...
        [ValidateInput(false)]
        [LogFilter]
        public virtual ActionResult Create(APILog model,bool returnData=false)
        {
            object newId = "";
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    hash["id"] = newId;
                    if(returnData){
                        APILog newrow = dal.GetModelByID(newId);
                        hash["data"] = newrow;
                    }
                }
        ...
        public  virtual List<APILog> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<APILog> modelList = new List<APILog>();
            switch(filterId)
            {
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"SiteManage_APILog_Show")]        
