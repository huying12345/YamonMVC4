...
//     如果想修改此文件的方法，请在此文件的上级目录中的AppDeviceController重写(override)该方法。
...
namespace Yamon.Module.App.Web.Controllers
{
    ...
    /// 设备模型
    /// </summary>
    public partial class _AppDeviceController :BaseController
    {

        public AppDeviceDAL dal = new AppDeviceDAL();
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            string formPath = string.Format("~/Areas/App/Views/AppDevice/_/{0}.cshtml", m);
...
public virtual ActionResult Show(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    AppDevice model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/App/Views/AppDevice/_/Show.cshtml");
