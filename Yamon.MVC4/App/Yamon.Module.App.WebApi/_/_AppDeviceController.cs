...
namespace Yamon.Module.App.WebApi
{
    ...
    public partial class _AppDeviceController :BaseController
    {
        ...
        [NonAction]        
        public  virtual List<AppDevice> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<AppDevice> modelList = new List<AppDevice>();
            switch(filterId)
            {
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"App_AppDevice_Show")]        
