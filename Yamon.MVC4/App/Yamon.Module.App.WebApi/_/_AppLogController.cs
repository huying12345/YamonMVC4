...
namespace Yamon.Module.App.WebApi
{
    ...
    public partial class _AppLogController :BaseController
    {
        ...
        [ValidateInput(false)]
        [LogFilter]
        public virtual ActionResult Create(AppLog model,bool returnData=false)
        {
            object newId = "";
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    hash["id"] = newId;
                    if(returnData){
                        AppLog newrow = dal.GetModelByID(newId);
                        hash["data"] = newrow;
                    }
                }
        ...
        public  virtual List<AppLog> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<AppLog> modelList = new List<AppLog>();
            switch(filterId)
            {
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"App_AppLog_Show")]        
