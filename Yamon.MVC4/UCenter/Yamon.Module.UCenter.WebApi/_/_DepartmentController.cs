...
namespace Yamon.Module.UCenter.WebApi
{
    ...
    public partial class _DepartmentController :BaseController
    {
        ...
        [ValidateInput(false)]
        [LogFilter]
        public virtual ActionResult Create(Department model,bool returnData=false)
        {
            object newId = "";
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    hash["id"] = newId;
                    if(returnData){
                        Department newrow = dal.GetModelByID(newId);
                        hash["data"] = newrow;
                    }
                }
        ...
        [LogFilter]
        public virtual ActionResult Edit(Department model,bool returnData=false)
        {
            try
            {
               ...
               if (result > 0)
                {
                    hash["id"] = model.DepartmentID;
                    if(returnData){
                        Department newrow = dal.GetModelByID(model.DepartmentID);
                        hash["data"] = newrow;
                    }
                }
            }
        ...
        [NonAction]        
        public  virtual List<Department> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
		...
		public  virtual ActionResult TreeGridByFilterID(string filterId)
        {
            ...
            try
            {
               ...
               List<Department> newModelList = modelList.Select(model => dal.GetModelGridShowValue(model)).ToList();
        ...
        public  virtual ActionResult TreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                string fields="DepartmentID,DepartmentName,ParentID,OrderID";
                ...
                TreeHelper treeHelper = new TreeHelper("DepartmentID", "DepartmentName", "OrderID", "ParentID");
        ...
        public  virtual ActionResult AsyncTreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                     ...
                     default:
                     {
                        table = dal.GetAsyncTreeList(parentId,"DepartmentID,DepartmentName");
                        break;
                     }
                }
                TreeHelper treeHelper = new TreeHelper("DepartmentID", "DepartmentName", "OrderID", "ParentID");
        ...
        {
            int result = dal.UpdateSingleFieldValue("DepartmentName", value,id );
            hash["success"] = result > 0;
            return Json(hash);
        }   
    [LogFilter]
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"UCenter_Department_Show")]        
