...
namespace Yamon.Module.UCenter.WebApi
{
    ...
    public partial class _RolePurviewController :BaseController
    {
        ...
        [NonAction]        
        public  virtual List<RolePurview> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<RolePurview> modelList = new List<RolePurview>();
            switch(filterId)
            {
        ...
        public  virtual ActionResult GridByFilterID(string filterId)
        {
            ...
            catch (Exception ex)
            {
                ...
                hash["rows"] = new List<RolePurview>();
            }
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"UCenter_RolePurview_Show")]        
        public ActionResult GetEntityByID(string id)
        {
            RolePurview model = dal.GetModelByID(id);
            if (model != null)
            {
                hash["data"] = model;
                hash["success"] = true;
