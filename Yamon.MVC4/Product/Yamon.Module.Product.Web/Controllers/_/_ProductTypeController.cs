...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _ProductTypeController :BaseController
    {
        ...
        {
            return Index("TreeGrid_Models","ProductType_Models");
        }
        public virtual ActionResult EditTree_Models()
        {
            return Index("EditTree_Models","ProductType_Models");
        }
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new ProductTypeDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/ProductType/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    ProductType model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductType/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductType/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    ProductType model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductType/_/Show.cshtml");
    return View(formPath,model);
}
