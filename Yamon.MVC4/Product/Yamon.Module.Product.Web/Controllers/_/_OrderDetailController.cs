...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _OrderDetailController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new OrderDetailDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/OrderDetail/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    OrderDetail model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/OrderDetail/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/OrderDetail/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    OrderDetail model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/OrderDetail/_/Show.cshtml");
    return View(formPath,model);
}
 		public ActionResult ImportFromExcel()
		{
			string formPath = "~/Areas/Product/Views/OrderDetail/_/ImportFromExcel.cshtml";
			string myFormPath = "~/Areas/Product/Views/OrderDetail/ImportFromExcel.cshtml";
			//是否有自定义页面
