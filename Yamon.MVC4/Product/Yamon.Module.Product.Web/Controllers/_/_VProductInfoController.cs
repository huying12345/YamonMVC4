...
//     如果想修改此文件的方法，请在此文件的上级目录中的VProductInfoController重写(override)该方法。
...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    /// 商品信息视图
    /// </summary>
    public partial class _VProductInfoController :BaseController
    {

        public VProductInfoDAL dal = new VProductInfoDAL();

        public virtual ActionResult Grid1_Models()
        {
            return Index("Grid1_Models","VProductInfo_Models");
        }
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new VProductInfoDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/VProductInfo/_/{0}.cshtml", m);
...
public virtual ActionResult Show(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    VProductInfo model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/VProductInfo/_/Show.cshtml");
