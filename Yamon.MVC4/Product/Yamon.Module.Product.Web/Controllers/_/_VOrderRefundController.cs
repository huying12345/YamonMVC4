...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _VOrderRefundController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new VOrderRefundDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/VOrderRefund/_/{0}.cshtml", m);
...
public virtual ActionResult Show(string id = "")
{
    ...
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/VOrderRefund/_/Show.cshtml");
