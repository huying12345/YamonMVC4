...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _ProductInfoController :BaseController
    {
        ...
        {
            return Index("Grid1_Models","ProductInfo_Models");
        }
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new ProductInfoDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/ProductInfo/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    ProductInfo model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductInfo/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductInfo/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    ProductInfo model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductInfo/_/Show.cshtml");
    return View(formPath,model);
}
