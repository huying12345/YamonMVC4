...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _ProductCardRecordController :BaseController
    {
        ...
        {
            return Index("Grid1_CardID","ProductCardRecord_CardID");
        }
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new ProductCardRecordDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/ProductCardRecord/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    ProductCardRecord model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductCardRecord/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductCardRecord/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    ProductCardRecord model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductCardRecord/_/Show.cshtml");
    return View(formPath,model);
}
