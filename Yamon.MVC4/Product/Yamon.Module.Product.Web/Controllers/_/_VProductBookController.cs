...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _VProductBookController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new VProductBookDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/VProductBook/_/{0}.cshtml", m);
...
public virtual ActionResult Show(string id = "")
{
    ...
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/VProductBook/_/Show.cshtml");
