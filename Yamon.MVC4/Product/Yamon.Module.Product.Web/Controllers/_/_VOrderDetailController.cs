...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _VOrderDetailController :BaseController
    {
        ...
        {
            return Index("Grid1_Models","VOrderDetail_Models");
        }
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new VOrderDetailDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/VOrderDetail/_/{0}.cshtml", m);
...
public virtual ActionResult Show(string id = "")
{
    ...
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/VOrderDetail/_/Show.cshtml");
