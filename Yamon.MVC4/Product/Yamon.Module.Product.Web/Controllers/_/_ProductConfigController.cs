...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _ProductConfigController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new ProductConfigDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/ProductConfig/_/{0}.cshtml", m);
...
public virtual ActionResult Edit(string id = "")
{
    ...
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/ProductConfig/_/Edit.cshtml");
