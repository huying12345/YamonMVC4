...
namespace Yamon.Module.Product.Web.Controllers
{
    ...
    public partial class _VProductBookDetailController :BaseController
    {
        ...
        public ActionResult Index(string m,string filterId)
        {
            ...
            ViewBag.DAL = new VProductBookDetailDAL();
            ...
            string formPath = string.Format("~/Areas/Product/Views/VProductBookDetail/_/{0}.cshtml", m);
...
public virtual ActionResult Create(string id = "")
{
    ViewBag.ID = id;
    ViewBag.DAL=dal;
    VProductBookDetail model= dal.GetCreateFormDefaultValue();
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/VProductBookDetail/_/Create.cshtml");
...
public virtual ActionResult Edit(string id = "")
{
    ...
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/VProductBookDetail/_/Edit.cshtml");
    return View(formPath,model);
}public virtual ActionResult Show(string id = "")
{
    ...
    VProductBookDetail model = dal.GetModelByID(id);
    model=dal.GetModelShowValue(model);
    string formPath = SiteCommon.GetCustomPage("~/Areas/Product/Views/VProductBookDetail/_/Show.cshtml");
    return View(formPath,model);
}
