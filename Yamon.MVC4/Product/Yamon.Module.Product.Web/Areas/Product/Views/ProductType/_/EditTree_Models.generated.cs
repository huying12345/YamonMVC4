...
namespace ASP
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/Product/Views/ProductType/_/EditTree_Models.cshtml")]
    public partial class _Areas_Product_Views_ProductType___EditTree_Models_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_Product_Views_ProductType___EditTree_Models_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 2 "..\..\Areas\Product\Views\ProductType\_\EditTree_Models.cshtml"
...
"oductType\';\r\n    var _pageUrl = \'&Models=");
            ...
            #line 30 "..\..\Areas\Product\Views\ProductType\_\EditTree_Models.cshtml"
            ...
            #line hidden
WriteLiteral("\';\r\n    jQuery(function () {\r\n        jQuery(\'#tt\').tree({\r\n            url: _api" +
"Url + \'/EditTree_Models?\' + _pageUrl,\r\n            animate: true,\r\n            d" +
"nd: true,\r\n            onDblClick: function (node) {\r\n                jQuery(\'#t" +
"t\').tree(\'beginEdit\', node.target);\r\n            },\r\n            onLoadSuccess: " +
"function (node, data) {\r\n                jQuery(\"#tt\").tree(\'collapseAll\');\r\n   " +
...
"              jQuery.ajax({\r\n                    url: _apiUrl + \'/SaveEditTree\'," +
"\r\n                    type: \'post\',\r\n                    dataType: \'json\',\r\n    " +
"                data: {\r\n                        id: source.id,\r\n               " +
"         targetId: targetId,\r\n                        point: point\r\n            " +
"        },\r\n                    success: function (data) {\r\n                    " +
"    if (data.success) {\r\n                            var node = jQuery(\'#tt\').tr" +
"ee(\'getRoot\');\r\n                        } else {\r\n                            al" +
"ert(data.message);\r\n                        }\r\n                        jQuery(\'#" +
"tt\').tree(\"reload\", node);\r\n                    }\r\n                });\r\n        " +
"    }\r\n        });\r\n    });\r\n\r\n</script>\r\n");
