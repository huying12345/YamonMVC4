...
namespace Yamon.Module.Product.WebApi
{
    ...
    public partial class _OrderInfoController :BaseController
    {
        ...
        {
             return GridByFilterID("OrderInfo_Models");
        } 
        ...
        [ValidateInput(false)]
        [LogFilter]
        public virtual ActionResult Create(OrderInfo model,bool returnData=false)
        {
            object newId = "";
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    hash["id"] = newId;
                    if(returnData){
                        OrderInfo newrow = dal.GetModelByID(newId);
                        hash["data"] = newrow;
                    }
                }
        ...
        [LogFilter]
        public virtual ActionResult Edit(OrderInfo model,bool returnData=false)
        {
            try
            {
               ...
               if (result > 0)
                {
                    hash["id"] = model.OrderID;
                    if(returnData){
                        OrderInfo newrow = dal.GetModelByID(model.OrderID);
                        hash["data"] = newrow;
                    }
                }
            }
        ...
        [NonAction]        
        public  virtual List<OrderInfo> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"Product_OrderInfo_Show")]        
