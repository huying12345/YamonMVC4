...
namespace Yamon.Module.Product.WebApi
{
    ...
    public partial class _VProductInfoController :BaseController
    {
        ...
        {
             return GridByFilterID("VProductInfo_Models");
        } 
        ...
        [NonAction]        
        public  virtual List<VProductInfo> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<VProductInfo> modelList = new List<VProductInfo>();
            switch(filterId)
            {
                    case "VProductInfo_Models":
                    {
        ...
        public  virtual ActionResult GridByFilterID(string filterId)
        {
            ...
            catch (Exception ex)
            {
                ...
                hash["rows"] = new List<VProductInfo>();
            }
