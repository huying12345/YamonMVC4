...
//     如果想修改此文件的方法，请在此文件的上级目录中的VProductBookController重写(override)该方法。
...
namespace Yamon.Module.Product.WebApi
{
    ...
    /// 预约视图
    /// </summary>
    public partial class _VProductBookController :BaseController
    {

        public VProductBookDAL dal = new VProductBookDAL();
        ...
        [NonAction]        
        public  virtual List<VProductBook> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<VProductBook> modelList = new List<VProductBook>();
            switch(filterId)
            {
        ...
        public  virtual ActionResult GridByFilterID(string filterId)
        {
            ...
            catch (Exception ex)
            {
                ...
                hash["rows"] = new List<VProductBook>();
            }
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"Product_VProductBook_Show")]        
        public ActionResult GetEntityByID(string id)
        {
            VProductBook model = dal.GetModelByID(id);
            if (model != null)
            {
                hash["data"] = model;
                hash["success"] = true;
