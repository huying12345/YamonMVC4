...
//     如果想修改此文件的方法，请在此文件的上级目录中的ProductTypeController重写(override)该方法。
...
namespace Yamon.Module.Product.WebApi
{
    ...
    /// 商品类型
    /// </summary>
    public partial class _ProductTypeController :BaseController
    {

        public ProductTypeDAL dal = new ProductTypeDAL();

        public virtual ActionResult TreeGrid_Models()
        {
             return TreeGridByFilterID("ProductType_Models");
        } 
        public virtual ActionResult EditTree_Models()
        {
             return TreeJsonByFilterID("ProductType_Models");
        } 
        ...
        [ValidateInput(false)]
        [LogFilter]
        public virtual ActionResult Create(ProductType model,bool returnData=false)
        {
            object newId = "";
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    hash["id"] = newId;
                    if(returnData){
                        ProductType newrow = dal.GetModelByID(newId);
                        hash["data"] = newrow;
                    }
                }
        ...
        [LogFilter]
        public virtual ActionResult Edit(ProductType model,bool returnData=false)
        {
            try
            {
               ...
               if (result > 0)
                {
                    hash["id"] = model.ProductTypeId;
                    if(returnData){
                        ProductType newrow = dal.GetModelByID(model.ProductTypeId);
                        hash["data"] = newrow;
                    }
                }
            }
        ...
        [NonAction]        
        public  virtual List<ProductType> GetGridList(string filterId, int showValue, out int totalRows)
        {
            totalRows = 0;
            ...
            List<ProductType> modelList = new List<ProductType>();
            switch(filterId)
            {
                    case "ProductType_Models":
                    {
        ...
        public  virtual ActionResult GridByFilterID(string filterId)
        {
            ...
            catch (Exception ex)
            {
                hash["success"] = false;
                hash["message"] = ex.Message;
                hash["rows"] = new List<ProductType>();
            }
            return Content(JsonConvert.SerializeObject(hash)); 
        }
		...
		public  virtual ActionResult TreeGridByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                        case "ProductType_Models":
                        {
                          modelList = dal.GetEntityListByPage_Models(out _totalRows,0,page,rows);
                          break;
                        }
               ...
               List<ProductType> newModelList = modelList.Select(model => dal.GetModelGridShowValue(model)).ToList();
        ...
        public  virtual ActionResult TreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                string fields="ProductTypeId,TypeName,ParentID,OrderID";
                ...
                switch(filterId)
                {
                        case "ProductType_Models":
                        {
                          table = dal.GetAllEntityTable_Models(fields);
                          break;
                        }
                ...
                TreeHelper treeHelper = new TreeHelper("ProductTypeId", "TypeName", "OrderID", "ParentID");
		...
		public  virtual ActionResult AsyncTreeGridByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
					case "ProductType_Models":
					{
					  modelList = dal.GetAsyncModelTreeList_Models(parentId);
					  break;
					}
        ...
        public  virtual ActionResult AsyncTreeJsonByFilterID(string filterId)
        {
            ...
            try
            {
                ...
                switch(filterId)
                {
                        case "ProductType_Models":
                        {
                          table = dal.GetAsyncTreeList_Models(parentId,"ProductTypeId,TypeName");
                          break;
                        }

                     default:
                     {
                        table = dal.GetAsyncTreeList(parentId,"ProductTypeId,TypeName");
                        break;
                     }
                }
                TreeHelper treeHelper = new TreeHelper("ProductTypeId", "TypeName", "OrderID", "ParentID");
        ...
        {
            int result = dal.UpdateSingleFieldValue("TypeName", value,id );
            hash["success"] = result > 0;
            return Json(hash);
        }   
    [LogFilter]
    ...
    public virtual ActionResult Delete(string id)
    {
        ...
        [CheckPurview(pageCode:"Product_ProductType_Show")]        
        public ActionResult GetEntityByID(string id)
        {
            ProductType model = dal.GetModelByID(id);
            if (model != null)
            {
                hash["data"] = model;
                hash["success"] = true;
